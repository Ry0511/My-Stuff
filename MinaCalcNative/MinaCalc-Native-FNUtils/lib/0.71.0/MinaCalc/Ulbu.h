...
#pragma region hand dependent pmod loop
	...
	void set_dependent_pmods(const int& itv)
	{
		...
		PatternMods::set_dependent(hand, _chain._pmod, _chain(_mitvhi), itv, _calc);
		PatternMods::set_dependent(hand, _cjohj._pmod, _cjohj(_mitvhi), itv, _calc);
		PatternMods::set_dependent(hand, _oht._pmod, _oht(_mitvhi._itvhi), itv, _calc);
		PatternMods::set_dependent(hand, _voht._pmod, _voht(_mitvhi._itvhi), itv, _calc);
		PatternMods::set_dependent(hand, _bal._pmod, _bal(_mitvhi._itvhi), itv, _calc);
		PatternMods::set_dependent(hand, _roll._pmod, _roll(_mitvhi._itvhi, _seq), itv, _calc);
		PatternMods::set_dependent(hand, _ch._pmod, _ch(_mitvhi._itvhi.get_taps_nowi()), itv, _calc);
		PatternMods::set_dependent(hand, _rm._pmod, _rm(_mitvhi._itvhi.get_taps_nowi()), itv, _calc);
		PatternMods::set_dependent(hand, _wrb._pmod, _wrb(_mitvhi._itvhi), itv, _calc);
		PatternMods::set_dependent(hand, _wrr._pmod, _wrr(_mitvhi._itvhi), itv, _calc);
		PatternMods::set_dependent(hand, _wrjt._pmod, _wrjt(_mitvhi._itvhi), itv, _calc);
		PatternMods::set_dependent(hand, _wra._pmod, _wra(_mitvhi._itvhi, _seq._as), itv, _calc);
	}
